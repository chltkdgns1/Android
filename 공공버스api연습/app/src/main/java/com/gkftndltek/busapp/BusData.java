...
public class BusData {
    private String endvehicletime,endnodenm,intervaltime,intervalsettime,intervalsuntime,routeid;
    private String routeno,routetp,startnodenm,startvehicletime;
